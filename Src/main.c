...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		/////////////////// Get ADC readings to find joystick positions ////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////////////////////////
		// //NOTE - if adc is reading all same comment out ADC_ChannelConfTypeDef sConfig = {0}; in adc init funtion
		// //as declared it as global instead
